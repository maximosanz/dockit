...
urlpatterns = patterns('',
    ...
    url(r'^model_select_(?P<target>[\S|^\_]+)_(?P<method>[\S|^\_]+)_(?P<refinement>[\S|^\_]+)_(?P<i_rmsd_threshold>[\S|^\_]+)_(?P<l_rmsd_threshold>[\S|^\_]+)_(?P<r_rmsd_threshold>[\S|^\_]+)_(?P<fnat_threshold>[\S|^\_]+)_(?P<rank_str>[\S|^\_]+)/$', views.model_select, name='model_select'),
